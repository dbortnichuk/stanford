package com.dbortnichuk.stanford.algorithms1.pq1;
...
//            System.out.println("Total file size to read (in bytes) : " + is.available());
    ...
    public static void main(String[] args) throws PerformanceEvaluatorException {
        ...
        InversionsCounter inversionsCounter = new InversionsCounter("/pq1q1.txt");
        Integer[] inputData = inversionsCounter.getDataAsArray();
